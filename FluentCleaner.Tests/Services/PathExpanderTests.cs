...
public class PathExpanderTests
{
    ...
    {
        // When ExpandVariables expands a bare drive reference that results in 2 chars (e.g. "C:"),
        // it appends Path.DirectorySeparatorChar to prevent relative CWD interpretation on Windows.
